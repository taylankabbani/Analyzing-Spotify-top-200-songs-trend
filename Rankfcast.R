...
Rankfcast <- function(SongName, Artist, show_ImputedValues =FALSE, study_e = FALSE, BestModel_show = FALSE){
  ...
  return(c(round(Best.Model$mean,0), RMSE))
}


#rank_pred <- Rankfcast('Kaçar Gider', 'Arda Gezer, Sehinsah, Helineda', show_ImputedValues = F, study_e = F, BestModel_show = T)