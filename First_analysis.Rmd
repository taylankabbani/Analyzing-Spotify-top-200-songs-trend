...
autoplot(fit) +
  autolayer(fitted(fit), series="Holt's method", PI=FALSE) +
...
song2_Rank <- na_interpolation(ts_ts(FindRank('Seni Dert Etmeler', 'Madrigal')))

# Frcasting the Rank 
train_prd <- subset(song2_Rank, end = length(song2_Rank)-1)
